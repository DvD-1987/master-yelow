...
const questionBankData = {
    ...
    1: [
        ...
        },
        {
            question: "印尼的官方语言是什么？",
            options: [
                { text: "英语", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "印尼语（Bahasa Indonesia）", correct: true, effect: {knowledge: 5, trust: 3, risk: -5} },
                { text: "荷兰语", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "阿拉伯语", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
            ],
        ...
        },
        {
            question: "印尼的时区是什么？",
            options: [
                { text: "UTC+7（西部时间）", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "UTC+8（中部时间）", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "跨越3个时区：UTC+7、UTC+8、UTC+9", correct: true, effect: {knowledge: 5, trust: 3, risk: -5} },
                { text: "UTC+9（东部时间）", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
            ],
        ...
        },
        {
            ...
            options: [
                { text: "商务活动完全停止", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "工作时间缩短，效率可能降低", correct: true, effect: {knowledge: 5, trust: 3, risk: -5} },
                { text: "没有任何变化", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "商务活动更加频繁", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
            ],
        ...
        },
        {
            ...
            options: [
                { text: "雅加达港", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "巴厘巴板港", correct: true, effect: {knowledge: 5, trust: 3, risk: -5} },
                { text: "泗水港", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "棉兰港", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
            ],
        ...
        },
        {
            ...
            options: [
                { text: "米饭", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "猪肉（除非确认对方非穆斯林）", correct: true, effect: {knowledge: 5, trust: 3, risk: -5} },
                { text: "鱼类", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "蔬菜", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
            ],
        ...
        },
        {
            ...
            options: [
                { text: "直接叫名字", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "使用尊称如'Bapak'（先生）或'Ibu'（女士）", correct: true, effect: {knowledge: 5, trust: 3, risk: -5} },
                { text: "叫绰号", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "用'喂'来称呼", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
            ],
        ...
        },
        {
            ...
            options: [
                { text: "温带季风气候", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "热带雨林气候", correct: true, effect: {knowledge: 5, trust: 3, risk: -5} },
                { text: "地中海气候", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "寒带气候", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
            ],
        ...
        },
        {
            ...
            options: [
                { text: "左手", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "右手或双手", correct: true, effect: {knowledge: 5, trust: 3, risk: -5} },
                { text: "随意哪只手", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "不用手，直接放桌上", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
            ],
        ...
        },
        {
            ...
            options: [
                { text: "无烟煤", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "动力煤（烟煤）", correct: true, effect: {knowledge: 5, trust: 3, risk: -5} },
                { text: "焦煤", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "褐煤", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
            ],
        ...
        },
        {
            ...
            options: [
                { text: "穿鞋直接进入", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "脱鞋后再进入", correct: true, effect: {knowledge: 5, trust: 3, risk: -5} },
                { text: "只脱一只鞋", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
                { text: "穿拖鞋进入", correct: false, effect: {knowledge: -3, trust: -2, risk: 5} },
            ],
