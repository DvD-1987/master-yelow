...
const level4BatchQuestions = [
    // 国际贸易术语（10道）
    {
        ...
        explanation: "CFR（成本加运费）和CIF（成本加保险费加运费）的主要区别是CIF包含保险费，CFR不包含。"
    },
    {
        ...
        explanation: "EXW（工厂交货）是卖方责任最小的术语，卖方只需在工厂或仓库将货物交给买方。"
    },
    {
        ...
        explanation: "DAP（Delivered at Place）目的地交货，卖方负责将货物运到指定目的地，但不负责卸货。"
    },
    {
        ...
        explanation: "DDP（完税后交货）是卖方责任最大的术语，卖方负责进口报关和缴纳进口税费。"
    },
    {
        ...
        explanation: "FAS（船边交货）中，卖方将货物交到船边（码头或驳船上）即完成交货义务。"
    },
    {
        ...
        explanation: "CPT（运费付至）可用于各种运输方式，而CFR仅适用于海运和内河运输。"
    },
    {
        ...
        explanation: "CIP（运费和保险费付至）可用于各种运输方式，而CIF仅适用于海运和内河运输。"
    },
    {
        ...
        explanation: "DAT（运输终端交货）是指卖方在指定目的地或目的港的集散站将货物卸下后完成交货。"
    },
    {
        ...
        explanation: "FOB条款下，买方负责租船订舱，卖方负责将货物装上买方指定的船舶。"
    },
    {
        ...
        explanation: "CIF条款下，卖方负责租船订舱和购买保险，但风险在装运港货物装上船时转移给买方。"
    },
    ...
    // 合同条款（15道）
    {
        ...
        explanation: "数量条款通常约定基准数量，并允许一定比例的溢短装（如±10%），以应对实际装船差异。"
    },
    {
        ...
        explanation: "检验条款必须明确约定检验机构、检验标准、取样方法和争议处理机制，避免纠纷。"
    },
    {
        ...
        explanation: "价格调整条款通常针对热值、灰分、硫分、水分等质量指标，根据实际检验结果调整价格。"
    },
    {
        ...
        explanation: "不可抗力包括自然灾害、战争、政府禁令等不能预见、不能避免、不能克服的客观情况。"
    },
    {
        ...
        explanation: "争议解决条款应约定仲裁机构或管辖法院，以及适用的法律，以便在发生争议时有明确的解决途径。"
    },
    {
        ...
        explanation: "装运期条款应约定具体装运期或装运期范围，以及延误的处理方式（如违约金、解除合同等）。"
    },
    {
        ...
        explanation: "所有权转移时间根据贸易术语约定，如FOB、CIF等都是在装运港货物装上船时转移。"
    },
    {
        ...
        explanation: "违约金条款主要是为了补偿守约方因违约造成的损失，同时对双方形成履约约束。"
    },
    {
        ...
        explanation: "保密条款通常包括价格、供应商信息、客户信息、技术资料等商业秘密，保护双方商业利益。"
    },
    {
        ...
        explanation: "合同生效条款应约定生效条件，如双方签字盖章、预付款到账等，明确合同何时开始具有法律效力。"
    },
    {
        ...
        explanation: "通知条款明确双方通知方式、地址，确保装船通知、付款通知等重要信息能够及时送达。"
    },
    {
        ...
        explanation: "合同修改条款通常约定必须以书面形式修改，并经双方签字确认，避免口头约定产生争议。"
    },
    {
        ...
        explanation: "转让条款通常约定未经对方同意，任何一方不得转让合同权利和义务，保护双方利益。"
    },
    {
        ...
        explanation: "合同终止条款通常包括履行完毕、双方协商一致、一方严重违约、不可抗力等情况。"
    },
    ...
    // 付款方式（10道）
    {
        ...
        explanation: "信用证是银行信用，开证行在单证相符条件下承担第一性付款责任，与买方是否付款无关。"
    },
    {
        ...
        explanation: "T/T是商业信用，主要风险是买方可能不付款或延迟付款，对卖方风险较大。"
    },
    {
        ...
        explanation: "D/P（付款交单）是指买方付款后才能从银行拿到单据，对卖方有一定保障。"
    },
    {
        ...
        explanation: "D/A（承兑交单）是指买方承兑汇票后即可从银行拿到单据，到期后再付款，对卖方风险较大。"
    },
    {
        ...
        explanation: "软条款是使信用证实际无法生效或使卖方无法履约的条款，如要求买方签字的检验证书等，是陷阱条款。"
    },
    {
        ...
        explanation: "预付款方式对买方风险最大，因为买方先付款，可能面临卖方不发货或货物质量不符的风险。"
    },
    {
        ...
        explanation: "不符点是指单据与信用证条款不一致的地方，如发票金额与信用证不符、装运期逾期等，可能导致拒付。"
    },
    {
        ...
        explanation: "分期付款通常约定合同签订付一部分（如30%），装船后付一部分（如70%），或到港后付清，平衡双方风险。"
    },
    {
        ...
        explanation: "信用证有效期应根据装运期和交单期合理设定，确保卖方有足够时间准备和提交单据。"
    },
    {
        ...
        explanation: "保证金是为了保证合同履行，一方违约时，另一方可以没收保证金或用于抵扣损失。"
    },
    ...
    // 谈判技巧（10道）
    {
        ...
        explanation: "成功的谈判应了解对方需求，寻找双赢方案，建立长期合作关系，而不是单方面施压。"
    },
    {
        ...
        explanation: "有效的价格谈判应了解市场行情，提出合理价格，并准备让步空间，同时关注质量、付款方式等其他条款。"
    },
    {
        ...
        explanation: "自己的底价和迫切程度是谈判的核心机密，不应轻易透露给对方，以免失去谈判主动权。"
    },
    {
        ...
        explanation: "合同条款谈判应综合考虑价格、质量、付款方式、交货期、违约责任等所有条款，不能只关注价格。"
    },
    {
        ...
        explanation: "遇到僵局时，可以暂时休会，寻找替代方案，或引入第三方协调，而不是终止谈判或强行施压。"
    }
];
