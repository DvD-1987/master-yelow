...
const level8BatchQuestions = [
    // 进口许可证与资质（10道）
    {
        ...
        explanation: "中国煤炭进口需要办理自动进口许可证，由商务部或其授权机构签发。"
    },
    {
        ...
        explanation: "煤炭进口企业需要具有进出口经营权，并在商务部备案，不是任何企业都可以进口。"
    },
    {
        ...
        explanation: "自动进口许可证当年有效，一般为6个月，需要在有效期内使用。"
    },
    {
        ...
        explanation: "没有自动进口许可证不能进口煤炭，属于无证进口，会被海关扣留并处罚。"
    },
    {
        ...
        explanation: "自动进口许可证当年有效，不能跨年度使用，过期需要重新申请。"
    },
    ...
    // 海关检验（15道）
    {
        ...
        explanation: "进口煤炭属于法定检验商品，必须经海关检验合格后才能销售使用。"
    },
    {
        ...
        explanation: "进口煤炭放射性核素活度浓度不得超过规定限值，超标将退运或销毁。"
    },
    {
        ...
        explanation: "进口煤炭需要检验灰分、硫分、汞、砷、磷、氟、氯等环保项目。"
    },
    {
        ...
        explanation: "进口煤炭检验不合格必须退运、销毁或技术处理，不能销售使用。"
    },
    {
        ...
        explanation: "进口煤炭通常在卸货港进行检验，由海关或指定检验机构执行。"
    },
    {
        ...
        explanation: "进口煤炭取样应在卸货过程中进行，确保样品代表性。"
    },
    {
        ...
        explanation: "质量索赔期由合同约定，通常为卸货后60-90天，超过期限不能索赔。"
    },
    {
        ...
        explanation: "进口煤炭重量检验采用水尺计重或衡器计重，以确定实际到货数量。"
    },
    {
        ...
        explanation: "发现短重应及时向船方或保险公司提出索赔，并保留相关证据。"
    },
    {
        ...
        explanation: "检验结果与合同不符时，应根据合同条款提出索赔或拒收，维护自身权益。"
    },
    ...
    // 报关与税费（10道）
    {
        ...
        explanation: "进口煤炭最惠国税率为0%，东盟国家享受协定税率也是0%。"
    },
    {
        ...
        explanation: "进口煤炭增值税税率为13%，以CIF价加关税为计税基础。"
    },
    {
        ...
        explanation: "进口煤炭完税价格以CIF价格为基础，包括货价、运费、保险费。"
    },
    {
        ...
        explanation: "进口报关单应在货物到港后14天内提交，逾期将产生滞报金。"
    },
    {
        question: "滞报金是如何计算的？",
        options: [
        ...
        explanation: "滞报金按日征收，为完税价格的0.05%，起征日为第15天。"
    },
    ...
    // 卸货与仓储（10道）
    {
        ...
        explanation: "卸货时应派人现场监督，记录卸货数量和质量，发现问题及时取证。"
    },
    {
        ...
        explanation: "煤炭不能与易燃物品混放，应分类存放，标识清楚，定期测温，保持通风。"
    },
    {
        ...
        explanation: "控制堆高，定期倒堆，监测温度可以防止煤炭自燃。"
    },
    {
        ...
        explanation: "进口煤炭堆存高度一般不应超过10米，过高会增加自燃风险。"
    },
    {
        ...
        explanation: "发现自燃迹象应立即倒堆降温，必要时使用阻燃剂，不能浇水或隐瞒。"
    }
];
